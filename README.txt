            ...
            23.01.2019 Решение разделено на три проекта. Проект bizapps_test.DAL является уровнем доступа к данным, в нем находятся классы для взаимодействия
              с базой данных.Проект bizapps_test.BLL является уровнем бизнес логики, в нем находятся классы для взаимодействия  с уровнем 
              доступа к данным.  Проект bizapps_test.WEB является уровнем представления, в нем находится разметка и классы для взаимодействия
              с уровнем бизнес-логики.
